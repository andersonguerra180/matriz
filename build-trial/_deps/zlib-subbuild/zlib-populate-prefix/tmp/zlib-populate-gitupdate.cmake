...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v1.3.1"
  WORKING_DIRECTORY "/Volumes/BUNKER 4TB/Apps/BKR Matriz/build-trial/_deps/zlib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Volumes/BUNKER 4TB/Apps/BKR Matriz/build-trial/_deps/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Volumes/BUNKER 4TB/Apps/BKR Matriz/build-trial/_deps/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
