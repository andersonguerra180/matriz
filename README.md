...
| `StorageWorkspaceComponent` | STORAGE workspace: detecção IOKit/SMART (SOURCE DRIVES / BACKUP DRIVES), Device Inspector compacto, timeline de uso e relatórios diários em Markdown (`/log/disk/<Disk>/`) |
